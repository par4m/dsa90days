                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        selectedDifficulty === difficulty
                          ? difficulty === 'Easy'
                            ? "bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 ring-1 ring-green-500/20"
                            : difficulty === 'Medium'
                            ? "bg-yellow-50 dark:bg-yellow-900/20 text-yellow-600 dark:text-yellow-400 ring-1 ring-yellow-500/20"
